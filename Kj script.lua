...
Section:NewButton("Ravage version 2 (dont need to be near others)", "Client", function()
loadstring(game:HttpGet("https://pastebin.com/raw/A1GFRYeW"))()
end)
...
local Section = Tab:NewSection("Credits to Camerawomanfr by the spawn anim and ravage version 2")
...
local Section = Tab:NewSection("delete it ) and for revive this hub, and for dropkicks")
...
local Section = Tab:NewSection("Credits to me for ravage version 2")
